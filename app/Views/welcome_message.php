        ...
        <li><a href="\login" class="btn btn-secondary" style="margin-top:7px; color:white;">เข้าสู่ระบบ</a></li>
            ...
            <div id="demo" class="carousel slide" data-bs-ride="carousel">
              ...
              <div class="carousel-inner">
                ...
                <img src="https://www.jogandjoy.run/upload/template/aMvIEu9UPwxMbNefhYefLpkLb9S67ACd.jpg" class="card__image" alt="" class="d-block" style="width:1000px; height:450px;">
                  <div class="carousel-caption">
                    
                  </div>
                </div>
                <div class="carousel-item">
                <img src="https://huahinmarathon.com/download/huahinmarathon_com/headerslide/header_slide_7_3751.jpg" class="card__image"alt=""class="d-block" style="width:1000px; height:450px;">
                  <div class="carousel-caption">
                    
                  </div> 
                </div>
                <div class="carousel-item">
                <img src="https://events.wingnaidee.com/images/banner-11.jpg" class="card__image" alt="" class="d-block" style="width:1000px; height:450px;">
                  <div class="carousel-caption">
